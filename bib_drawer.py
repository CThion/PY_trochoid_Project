...
def on_language():
  ...
  #elif st.win.min == "Francais" and key_butt == "trocho" :    
  ...
  #elif st.win.min == "Francais" and key_butt == "fixe" :    
  ...
  #elif st.win.min == "Anglais" and key_butt == "trocho" :
  ...
  #elif st.win.min == "Anglais" and key_butt == "fixe" :    
  ...
  #elif st.win.min == "Espagnol" and key_butt == "trocho" :    
  ...
  #elif st.win.min == "Espagnol" and key_butt == "fixe" :    
  ...
  #elif st.win.min == "Japonais" and key_butt == "trocho" :    
  ...
  #elif st.win.min == "Japonais" and key_butt == "fixe" :    
